...
const FormPage: React.FC = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-slate-900 font-sans">
      ...
      <main className="w-full relative z-10 pt-28 pb-16 md:pt-32 md:pb-20 min-h-[85vh] flex flex-col items-center justify-center">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-center">
          ...
          <p className="text-slate-200 text-sm md:text-base max-w-xl mx-auto drop-shadow-md font-medium mb-8">
